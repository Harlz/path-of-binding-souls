...
//	Brief:	Checks if the camera is going to collide with any environment
//	objects on the way to its new target position, returns a new target
//	position for the camera so it will not go through walls, etc.
//---------------------------------
